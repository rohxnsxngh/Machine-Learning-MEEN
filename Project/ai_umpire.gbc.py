...
for HP in umpires:
    ...
    gb_model = GradientBoostingClassifier(n_estimators=100, learning_rate=0.1, max_depth=3, random_state=None)
    ...
    y_contour = gb_model.predict(X_contour)
...
# In this modification, I replaced the Random Forest Classifier with a Gradient Boosting Classifier (GradientBoostingClassifier). 
# The n_estimators, learning_rate, and max_depth are hyperparameters that we can adjust based on your specific dataset and requirements.